...
// $[PRS]
#define PORTIO_PRS_ASYNCH4_PIN                (2U)
#define PORTIO_PRS_ASYNCH4_PORT               (gpioPortA)

#define BSP_PRS_CH4_SOURCE                    (PRS_ASYNC_CH_CTRL_SOURCESEL_RAC)
#define BSP_PRS_CH4_SIGNAL                    (PRS_ASYNC_CH_CTRL_SIGSEL_RACPAEN)
#define BSP_PRS_CH4_SOURCESIGNAL              (PRS_ASYNC_RAC_PAEN)
#define BSP_PRS_CH4_PIN                       (3U)
#define BSP_PRS_CH4_PORT                      (gpioPortA)
